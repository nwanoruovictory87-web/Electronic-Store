...
function ProductItem(props) {
  ...
  return (
    <span
      className="product-item flex flex-col bg-[#fffffff5] w-[10.5rem] max-w-[280px] min-h-[300px] items-stretch p-1.5 rounded-md flex-grow hover:shadow-lg hover:-translate-y-1 transition-all pb-3"
    ...
    >
      ...
      <span className="mt-2 flex flex-col pl-1 border-b-2 pb-1">
      ...
      {!orderPass ? (
        ...
        >
          ...
          <span className="inline-block w-12 h-12 bg-gray-100 rounded-full pl-2 remove-xmark ml-auto mt-[-9px] pt-2.5 mr-[-4px]">
            <i className="fa fa-shopping-cart text-[1.5rem] text-gray-800 "></i>
          </span>
        </span>
      ) : (
        <span className="swicth-button w-full block mt-1 pl-2 pr-2 ">
          <span
            className="bg-[#da090996] w-full h-10 rounded-3xl flex pl-1.5  p-1 hover:bg-[#da0909]  "
          ...
          >
            ...
            <span className="inline-block w-12 h-12 bg-gray-100 rounded-full pl-2 remove-xmark ml-auto mt-[-9px] pt-2.5 mr-[-4px]">
              <i className="fa fa-xmark text-[1.5rem] text-gray-800 "></i>
            </span>
          </span>
        </span>
      )}
