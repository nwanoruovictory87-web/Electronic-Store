...
function Menu(props) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-700 w-[70%] h-screen overflow-y-auto pb-10">
      ...
      <div className="flex flex-col mt-7 pl-6 gap-5 pr-6">
        ...
        >
          <h5 className="text-xl ml-2 text-gray-100 pt-0.5 mr-auto">BATTERY</h5>
          <i className="fas fa-angle-right text-xl text-gray-100"></i>
        </span>
        <span
          className="flex border-b-2 pb-1.5"
        ...
        >
          <h5 className="text-xl ml-2 text-gray-100 pt-0.5 mr-auto">COOKER</h5>
          <i className="fas fa-angle-right text-xl text-gray-100"></i>
        </span>
        <span
          className="flex border-b-2 pb-1.5"
